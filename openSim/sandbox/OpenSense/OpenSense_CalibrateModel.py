...
### THis must be changed to fit the xml file
modelFileName = 'Rajagopal_2015.osim'          # The path to an input model
orientationsFileName = '../config/MT_012005D6_009-001_orientations.sto'   # The path to orientation data for calibration
...
visualizeCalibration = True                     # Boolean to Visualize the Output model
