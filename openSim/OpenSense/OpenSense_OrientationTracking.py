...
modelFileName = 'calibrated_Rajagopal_2015_modified.osim'                # The path to an input model
resultsDirectory = 'IKResults_modified'
...
sensor_to_opensim_rotation = osim.Vec3(-1.570796, 0, 0) # The rotation of IMU data to the OpenSim world frame
